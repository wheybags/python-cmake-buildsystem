...
if (USE_HUNTER_LIBRARIES)
    hunter_add_package(BZip2)
    find_package(BZip2 CONFIG REQUIRED)
    SET(BZIP2_LIBRARIES BZip2::bz2)
    get_property(BZIP2_INCLUDE_DIR TARGET BZip2::bz2 PROPERTY INTERFACE_INCLUDE_DIRECTORIES)

    # Curses missing
    set(HAVE_LIBCURSES <HAVE_LIBCURSES>-NOTFOUND)
    set(HAVE_CURSES_H NO)
    set(HAVE_NCURSES_H NO)
    set(HAVE_NCURSES_PANEL_H NO)


    hunter_add_package(Expat)
    find_package(EXPAT CONFIG REQUIRED)
    set(EXPAT_LIBRARIES EXPAT::expat)
    get_property(EXPAT_INCLUDE_DIRS TARGET EXPAT::expat PROPERTY INTERFACE_INCLUDE_DIRECTORIES)
    ...
    get_property(SQLITE3_INCLUDE_PATH TARGET sqlite3::sqlite3 PROPERTY INTERFACE_INCLUDE_DIRECTORIES)

    # readline/libedit missing
    set(HAVE_READLINE_READLINE_H NO)
    set(HAVE_LIBREADLINE <HAVE_LIBREADLINE>-NOTFOUND)
else()
